                ...
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="home-04.html" class="biolife-logo"><img
                                src="/assets/template/images/organic-3-green.png" alt="biolife logo" width="135"
                                height="36"></a>
                    </div>
                                            ...
                                            <ul class="products">
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="##"><img src="/assets/template/images/minicart/pr-01.jpg"
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="##"><img src="/assets/template/images/minicart/pr-02.jpg"
                                                                    width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="##"
                                                            ...
                                                            <div class="qty">
                                                                ...
                                                                <input type="number" class="input-qty" name="cart[id124][qty]"
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="##"><img src="/assets/template/images/minicart/pr-03.jpg"
                                                                    width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="##"
                                                            ...
                                                            <div class="qty">
                                                                ...
                                                                <input type="number" class="input-qty" name="cart[id125][qty]"
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="##"><img src="/assets/template/images/minicart/pr-04.jpg"
                                                                    width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="##"
                                                            ...
                                                            <div class="qty">
                                                                ...
                                                                <input type="number" class="input-qty" name="cart[id126][qty]"
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="##"><img src="/assets/template/images/minicart/pr-05.jpg"
                                                                    width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="##"
                                                            ...
                                                            <div class="qty">
                                                                ...
                                                                <input type="number" class="input-qty" name="cart[id127][qty]"
        ...
        <div class="header-bottom hidden-sm hidden-xs">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        <div class="vertical-menu vertical-category-block">
                            <div class="block-title">
                                ...
                                <span class="angle" data-tgleclass="fa fa-caret-down"><i
                            ...
                            <div class="wrap-menu">
                                <ul class="menu clone-main-menu">
                                                            ...
                                                            <ul
                                                                    ...
                                                                    <div class="contain-product none-overlay">
                                                                        <div class="product-thumb">
                                                                            <a href="##" class="link-to-product">
                                                                                <img src="/assets/template/images/products/p-08.jpg" alt="dd"
                                                                ...
                                                                <li class="product-item">
                                                                    <div class="contain-product none-overlay">
                                                                        <div class="product-thumb">
                                                                            <a href="##" class="link-to-product">
                                                                                <img src="/assets/template/images/products/p-11.jpg" alt="dd"
                                                                                    width="270" height="270" class="product-thumnail">
                                                                            </a>
                                                                        </div>
                                                                        <div class="info">
                                                                ...
                                                                <li class="product-item">
                                                                    <div class="contain-product none-overlay">
                                                                        <div class="product-thumb">
                                                                            <a href="##" class="link-to-product">
                                                                                <img src="/assets/template/images/products/p-15.jpg" alt="dd"
                                                                                    width="270" height="270" class="product-thumnail">
                                                                            </a>
                                                                        </div>
                                                                        <div class="info">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                                                        <div class="biolife-brand">
                                                            <ul class="brands">
                                                                <li><a href="##"><img
                                                                            src="/assets/template/images/megamenu/brand-organic.png" width="161"
                                                                            height="136" alt="organic"></a></li>
                                                                <li><a href="##"><img
                                                                            src="/assets/template/images/megamenu/brand-explore.png" width="160"
                                                                            height="136" alt="explore"></a></li>
                                                                <li><a href="##"><img
                                                                            src="/assets/template/images/megamenu/brand-organic-2.png" width="99"
                                                                            height="136" alt="organic 2"></a></li>
                                                                <li><a href="##"><img
                                                                            src="/assets/template/images/megamenu/brand-eco-teas.png" width="164"
                                                                            height="136" alt="eco teas"></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="menu-item"><a href="##" class="menu-title"><i
                                                class="biolife-icon icon-fresh-juice"></i>Fresh Bananas &
                                            Plantains</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 padding-top-2px">
                        <div></div>
                        <div class="live-info">
