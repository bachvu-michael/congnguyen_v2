component {
    ...
    public void function configure( required struct config ) {
        ...
        settings.features.oneClickLocalLogin = { enabled=true, siteTemplates=[ "*" ], widgets=[] };
        settings.features.dumpLogs           = { enabled=true, siteTemplates=[ "*" ], widgets=[] };
        settings.features.devQuickLinks      = { enabled=true, siteTemplates=[ "*" ], widgets=[] };
        settings.features.featureInfo        = { enabled=true,  siteTemplates=[ "*" ], widgets=[] };
