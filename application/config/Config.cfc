...
// CORE COLDBOX CONFIGURE METHOD(S)
	public void function configure() {
		...
		// settings.coldbox.reinitPassword = "bachvu123"; // for devQuickLinks re-init
		// coldbox.reinitPassword = "bachvu123";
		settings.adminLanguages    = ["en","vi"];
...
// HELPERS
	private void function _setupCommonSettings() {
		...
		settings.default_log_name   = "congnguyen";
		settings.default_log_level  = "information";
		settings.sql_log_name       = "congnguyen";
